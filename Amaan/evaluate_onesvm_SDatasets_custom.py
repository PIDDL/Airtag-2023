...
for j in range(1,11):
  threshold=0.3
  predict_labels=second_class('/home/tpiuser2/prov_project/amaan/training_data/'+suffix+path[flag-1],a_labels,threshold,flag)
  a1=0
  a2=0
  a3=0
  a4=0
  ...
  fpresults=[]
  benign_benign=[]
  logs_f=open('/home/tpiuser2/prov_project/amaan/training_data/'+suffix+path[flag-1],'r')
