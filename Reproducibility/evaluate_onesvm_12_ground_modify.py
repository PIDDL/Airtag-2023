...
f=open("/home/tpiuser2/prov_project/amaan/embedding_data/"+suffix+"M12_benign.json", 'r')
...
f=open("/home/tpiuser2/prov_project/amaan/embedding_data/"+suffix+"M121_test.json", 'r')
...
strr=np.load("/home/tpiuser2/prov_project/amaan/ground_data/"+suffix+"M1h1_number.npy")
strr=list(strr)
...
predict_labels=second_class("/home/tpiuser2/prov_project/amaan/training_data/"+suffix+"testing_preprocessed_logs_M1-CVE-2015-5122_windows_h1",predict_labels,float(args.thres))
...
start_load_test_time=time.time()
f=open("/home/tpiuser2/prov_project/amaan/embedding_data/"+suffix+"M122_test.json",'r')
strr=f.read().split("\n")
f.close()
for i in range(len(strr)-1):
  strr[i]=strr[i].split('"values"')[1:]
...
print("end load test")
#print(end_load_test_time-start_load_test_time)
strr=np.load("/home/tpiuser2/prov_project/amaan/ground_data/"+suffix+"M1h2_number.npy")
strr=list(strr)
labels=np.ones(len(value2))
for i in range(len(strr)):
  if int(strr[i])<=len(value2):
...
start_cali_time=time.time()
predict_labels=second_class("/home/tpiuser2/prov_project/amaan/training_data/"+suffix+"testing_preprocessed_logs_M1-CVE-2015-5122_windows_h2",predict_labels)
end_cali_time=time.time()
#print("end cali  time")
#print(end_cali_time-start_cali_time)
a1=0
...
start_load_test_time=time.time()
f=open("/home/tpiuser2/prov_project/amaan/embedding_data/"+suffix+"M123_test.json",'r')
strr=f.read().split("\n")
f.close()
for i in range(len(strr)-1):
  strr[i]=strr[i].split('"values"')[1:]
...
print("end load test")
#print(end_load_test_time-start_load_test_time)
strr=np.load("/home/tpiuser2/prov_project/amaan/ground_data/"+suffix+"M2h1_number.npy")
strr=list(strr)
labels=np.ones(len(value2))
for i in range(len(strr)):
  if int(strr[i])<=len(value2):
...
start_cali_time=time.time()
predict_labels=second_class("/home/tpiuser2/prov_project/amaan/training_data/"+suffix+"testing_preprocessed_logs_M2-CVE-2015-5119_windows_py_h1",predict_labels)
end_cali_time=time.time()
#print("end cali  time")
#print(end_cali_time-start_cali_time)
...
start_load_test_time=time.time()
f=open("/home/tpiuser2/prov_project/amaan/embedding_data/"+suffix+"M124_test.json",'r')
strr=f.read().split("\n")
f.close()
for i in range(len(strr)-1):
  strr[i]=strr[i].split('"values"')[1:]
...
#print(end_load_test_time-start_load_test_time)
value2=np.array(strr[:-1])
strr=np.load("/home/tpiuser2/prov_project/amaan/ground_data/"+suffix+"M2h2_number.npy")
strr=list(strr)
labels=np.ones(len(value2))
for i in range(len(strr)):
  if int(strr[i])<=len(value2):
...
start_cali_time=time.time()
predict_labels=second_class("/home/tpiuser2/prov_project/amaan/training_data/"+suffix+"testing_preprocessed_logs_M2-CVE-2015-5119_windows_py_h2",predict_labels)
end_cali_time=time.time()
#print("end cali  time")
#print(end_cali_time-start_cali_time)
a1=0
